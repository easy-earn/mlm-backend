...
export const getResourceByTherapyIdPipeline = (filter, userid, option = null, optionalFilter = null) => {
...
export const getResourceForSubCategoryPipeline = (filter, userid, option = null, resourceTypeId = null) => {
...
export const getTop10MostUsedResource = (option = null) => {
